...
function handleTabPanes() {
var e = $(".demo .myPanes");
var t = randomNumber();
var n = "panes-" + t;
e.attr("id", n);
$(".myPanes .accordion-toggle").attr("data-parent","#" + e.attr("id"));
e.find(".accordion-toggle").each(function (e, t) {
    var r = "panel-" + randomNumber();
    var n = t.parentNode.parentNode.nextElementSibling;
    $(t).attr("href", "#" + r);
    $(n).attr("id",r);
    })
}
